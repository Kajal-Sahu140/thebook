        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.product.store') }}" id="addProductForm" method="POST" enctype="multipart/form-data">
                    ...
                    <!--    <input type="text" class="form-control @error('product_name_ar') is-invalid @enderror" id="product_name_ar" name="product_name_ar" value="{{ old('product_name_ar') }}" placeholder="Enter product name">-->
                    ...
                    <!--    <input type="text" class="form-control @error('product_name_cku') is-invalid @enderror" id="product_name_cku" name="product_name_cku" value="{{ old('product_name_cku') }}" placeholder="Enter product name">-->
                    ...
                    <!--    <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar" name="description_ar" placeholder="Enter product description">{{old('description_ar')}}</textarea>-->
                    ...
                    <!--    <textarea class="form-control @error('description_cku') is-invalid @enderror" id="description_cku" name="description_cku" placeholder="Enter product description">{{old('description_cku')}}</textarea>-->
                   ...
                   <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <select name="product_type" id="language" class="form-control">
        ...
        <!-- Image previews with delete buttons will appear here -->
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                                ...
                                <div class="col">
                                    <input type="number"  min="0" max="9999999.99" 
        ...
        messages: {
           ...
           base_price: {
            ...
            'variant_prices[]':{
                ...
                max: "Variant price cannot exceed 999999.99.",
...
addVariantButton.addEventListener('click', function() {
    ...
    newVariant.innerHTML = `
        ...
        maxlength="9"  name="variant_prices[]" id="variant_prices" class="form-control" placeholder="Price" value="" >
        </div>
        <div class="col-auto">
            <button type="button" class="btn btn-danger remove-variant-btn">
                <i class="fas fa-trash"></i>
