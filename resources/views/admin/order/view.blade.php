...
<div class="col-sm-12">
   ...
   class="btn btn-dark" 
   style="right: 100px; position: absolute; margin-top: 60px">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" value="IQD {{ $CartOrderSummary->grand_total }}" disabled>
                </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @foreach ($CartOrderSummary->cartItems as $cartItem)
                            <tr>
                                <td>
                                    <img src="{{ $cartItem->product->images->first()->image_url ?? asset('images/default-product.png') }}" alt="Product" class="product-image">
                                </td>
