...
<div class="col-sm-12">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb float-end">
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Libraris</li>
        </ol>
    </nav>
</div>
<main class="content">
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Add Libraris</h1>
        <div class="card">
            <div class="card-body">
                <form id="addCategoryForm" action="{{route('admin.library.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-3">
     ...
     <div class="mb-3">
        ...
        <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" 
            value="{{ old('address') }}" placeholder="Enter  addressName">
        @error('address')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
     ...
     <div class="mb-3">
        ...
        <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" 
            value="{{ old('phone') }}" placeholder="Enter  addressName">
        @error('phone')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
