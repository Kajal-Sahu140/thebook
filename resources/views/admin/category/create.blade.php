...
<main class="content">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="name_ar" id="name_ar" class="form-control @error('name_ar') is-invalid @enderror" 
            value="{{ old('name_ar') }}" placeholder="Enter Category Name">
        @error('name_ar')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="name_cku" id="name_cku" class="form-control @error('name_cku') is-invalid @enderror" 
            value="{{ old('name_cku') }}" placeholder="Enter Category Name">
        @error('name_cku')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
    ...
    <div class="mb-3">
     ...
     <div class="mb-3">
        ...
        <textarea name="description_ar" id="description_ar" rows="4" class="form-control @error('description_ar') is-invalid @enderror" 
            placeholder="Enter a description for the category">{{ old('description_ar') }}</textarea>
     ...
     <div class="mb-3">
        ...
        <textarea name="description_cku" id="description_cku" rows="4" class="form-control @error('description_cku') is-invalid @enderror" 
            placeholder="Enter a description for the category">{{ old('description_cku') }}</textarea>
    ...
    <div class="mb-3">
     ...
     <div class="mb-3">
        ...
        @error('image_ar')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
        <img id="imagePreviewar" src="#" alt="Image Preview" style="display: none; margin-top: 10px; max-height: 150px;">
    </div>
     <div class="mb-3">
        <label for="image" class="form-label">Category Image (CKU)</label>
        <input type="file" name="image_cku" id="image" class="form-control @error('image_cku') is-invalid @enderror" onchange="previewImagecku(event)">
        @error('image_cku')
            <span class="invalid-feedback">{{ $message }}</span>
        @enderror
        <img id="imagePreviewcku" src="#" alt="Image Preview" style="display: none; margin-top: 10px; max-height: 150px;">
    </div>
