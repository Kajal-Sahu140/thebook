...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3 d-flex justify-content-end flex-wrap">
           ...
           <a href="{{route('admin.category.create')}}" class="btn btn-info ms-sm-3 mt-2 mt-sm-0">
                            ...
                            <tr>
                               ...
                               <td>{{ Str::limit($user->description, 30) ?? '' }}</td>
                                ...
                                <span class="badge {{ $user->status === 1 ? 'bg-success' : 'bg-danger' }}">
                                 ...
                                 <td>
                                    <a class="btn btn-outline-secondary btn-flat mr-1" href="{{route('admin.subcategory',base64_encode($user->id))}}"> <i class="fa fa-list"></i> </a>
                                    <a href="{{ route('admin.category.edit', base64_encode($user->id)) }}" class="btn btn-warning btn-sm">Edit</a>
