...
<main class="content">
    <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Sub Category</h1>
        <div class="mb-3 d-flex justify-content-end flex-wrap">
             <form action="{{ route('admin.subcategory', base64_encode($category->id)) }}" method="GET" class="d-flex flex-grow-1 flex-sm-grow-0">
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Search button disabling functionality
    });
</script>
@endsection
