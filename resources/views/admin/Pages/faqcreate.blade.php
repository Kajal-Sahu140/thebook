                ...
                <form id="addFaqForm" action="{{ route('admin.faq.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="question" id="question" class="form-control @error('question') is-invalid @enderror" 
                               value="{{ old('question') }}" placeholder="Enter the FAQ question">
                        @error('question')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="question_ar" id="question_ar" class="form-control @error('question_ar') is-invalid @enderror" 
                               value="{{ old('question_ar') }}" placeholder="Enter the FAQ question">
                        @error('question_ar')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                        ...
                        <input type="text" name="question_cku" id="question_cku" class="form-control @error('question_cku') is-invalid @enderror" 
                               value="{{ old('question_cku') }}" placeholder="Enter the FAQ question">
                        @error('question_cku')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <textarea name="answer_ar" id="answer_ar" rows="4" class="form-control @error('answer_ar') is-invalid @enderror" 
                                  placeholder="Enter the FAQ answer">{{ old('answer_ar') }}</textarea>
                        @error('answer_ar')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                        ...
                        <textarea name="answer_cku" id="answer_cku" rows="4" class="form-control @error('answer_cku') is-invalid @enderror" 
                                  placeholder="Enter the FAQ answer">{{ old('answer_cku') }}</textarea>
                        @error('answer_cku')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <input type="text" name="category" id="category" class="form-control @error('category') is-invalid @enderror" 
                               value="{{ old('category') }}" placeholder="Enter the FAQ category">
                        @error('category')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div> -->
