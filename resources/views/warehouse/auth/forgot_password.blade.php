                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0 shadow">
                            <div class="card-body pt-5">
                                ...
                                <h4 class="text-center">Warehouse Forgot Password</h4>

                                <!-- Login Form -->
                                <form id="loginForm" action="{{ route('warehouse.access.forgetPasswordProcess') }}" method="POST" class="mt-4 mb-5 login-input needs-validation" novalidate>
                                    @csrf
