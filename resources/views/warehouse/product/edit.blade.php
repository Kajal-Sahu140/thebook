...
<div class="content-body">
 <div class="container-fluid mt-3">
   ...
   <div class="card">
      <div class="card-body">
         <form action="{{ route('warehouse.product.update', base64_encode($product->product_id)) }}" id="addProductUpdateForm" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Product Name -->
            <div class="mb-3">
               <label for="product_name" class="form-label">Product Name</label>
               <input type="text" class="form-control @error('product_name') is-invalid @enderror" id="product_name" name="product_name" value="{{ old('product_name', $product->product_name) }}" placeholder="Enter product name">
               @error('product_name')
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control @error('product_name_ar') is-invalid @enderror" id="product_name_ar" name="product_name_ar" value="{{ old('product_name_ar', $product->product_name_ar) }}" placeholder="Enter product name (AR)">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control @error('product_name_cku') is-invalid @enderror" id="product_name_cku" name="product_name_cku" value="{{ old('product_name_cku', $product->product_name_cku) }}" placeholder="Enter product name (CKU)">
            ...
            <div class="mb-3">
               ...
               <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar" name="description_ar" placeholder="Enter product description">{{ old('description_ar', $product->description_ar) }}</textarea>
            ...
            <div class="mb-3">
               ...
               <textarea class="form-control @error('description_cku') is-invalid @enderror" id="description_cku" name="description_cku" placeholder="Enter product description">{{ old('description_cku', $product->description_cku) }}</textarea>
            ...
            <div class="mb-3">
               ...
               @if($product->images)
               <div id="existing-images" class="mt-2" style="display: flex; gap: 10px; flex-wrap: wrap;">
               ...
               @endif
               <!-- Preview new images -->
               <div id="imagePreviewContainer" class="mt-3" style="display: flex; gap: 10px; flex-wrap: wrap;">
            ...
            <div class="mb-3">
               ...
               <div id="variants">
                  ...
                  <div class="variant-row row mb-2">
                     ...
                     <!-- <div class="col">
                        <input type="number" step="1" min="0" max="9999999.99" 
                           maxlength="10"  id="variant_prices" name="variant_prices[]" class="form-control" placeholder="Price" value="{{ $variant->price }}">
                     </div> -->
                       <div class="col">
...
<script>
   ...
   // Handle removing images (both old and new images)
   existingImagesContainer.addEventListener('click', function (event) {
      if (event.target && event.target.closest('.remove-image-btn')) {
          ...
          if (imageId) {
              // Send an AJAX request to remove the image (for existing images)
              fetch("{{ route('warehouse.product.removeImage') }}", {
                  method: 'POST',
                  headers: {
              ...
              // For new images, simply remove the image container from the DOM
              imageContainer.remove();
          }
      }
   });
   ...
   //////////////////////////////////
      ...
      addVariantButton.addEventListener('click', function () {
          ...
          maxlength="10"  name="variant_prices[]" class="form-control" placeholder="Price" value="">
              </div>
              <div class="col-auto">
                  <button type="button" class="btn btn-danger remove-variant-btn">
                      <i class="fas fa-trash"></i>
